...
if __name__ == '__main__':
    ...
    underlying_name = "Results/expanding_bollinger_band_Daily/"+symbol

    initial_capital = 1000000
    trading_cost = 0.0000

    trades, price_signal = expanding_bollinger_band_system.expanding_bollinger_band_system(price_data,10,period="")
