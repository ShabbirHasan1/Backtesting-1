...
from Strategies import pattern_system as system
...
if __name__ == '__main__':
    ...
    underlying_name = "Results/Pattern_Daily"+"/NZ1 Index"
    ...
    trades, price_signal = system.pattern_system(price_data,44,4,period="")
