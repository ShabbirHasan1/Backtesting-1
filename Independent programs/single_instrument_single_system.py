...
from Strategies import rsi50-55sma_system as system
...
if __name__ == '__main__':
    ...
    underlying_name = "Results/rsi50-55sma"+"/NZ1 Index"
    ...
    trades, price_signal = system.sma_crossover_system(price_data, period_1,period="")
