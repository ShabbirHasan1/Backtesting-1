...
from Strategies import rsi2_50sma_system as system
...
if __name__ == '__main__':
    ...
    underlying_name = "Results/rsi2-50sma_Daily"+"/NZ1 Index"
    ...
    trades, price_signal = system.rsi2_50sma_system(price_data,period_1,period_2,stop_level,period="")
