...
from Strategies import oscillator_system as system
...
if __name__ == '__main__':
    ...
    underlying_name = "Results/oscillator_Daily"+"/NZ1 Index"
    ...
    trades, price_signal = system.oscillator_system(price_data,period="")
