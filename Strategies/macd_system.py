...
def macd_system(price_data, period="",trade_type="Both_leg", underlying_instrument_data=None):
    ...
    price_signal_period["Signal"] = np.where((price_signal_period["macd_diff"] > 0), 1, -1)
